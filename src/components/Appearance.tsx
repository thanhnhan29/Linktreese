...
export default function Appearance({
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      const mergedConfig = {
        ...
        textColors: {
          ...DEFAULT_CONFIG.textColors,
          ...(savedConfig.textColors || {}),
        },
      };
  ...
  const updateBackground = (
    updates: Partial<AppearanceConfig["background"]>
  ) => {
    updateConfig({
  ...
  const updateTextColors = (
    updates: Partial<AppearanceConfig["textColors"]>
  ) => {
    updateConfig({
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          onChange={(e) =>
                            updateBackground({ gradientStart: e.target.value })
                          }
                          className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                        />
                        <input
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          onChange={(e) =>
                            updateBackground({ gradientEnd: e.target.value })
                          }
                          className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                        />
                        <input
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateButtons({ backgroundColor: e.target.value })
                      }
                      className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                    />
                    <input
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateButtons({ textColor: e.target.value })
                      }
                      className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                    />
                    <input
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        updateButtons({ hasShadow: e.target.checked })
                      }
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateTextColors({ username: e.target.value })
                      }
                      className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                    />
                    <input
                  ...
                  <div className="mt-2 p-3 bg-gray-50 rounded border border-gray-200">
                    ...
                    <p
                      style={{
                        color: config.textColors.username,
                        fontFamily: `${config.fonts.heading}, sans-serif`,
                      }}
                    >
                      @username
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateTextColors({ description: e.target.value })
                      }
                      className="w-16 h-16 rounded-lg cursor-pointer border-2 border-gray-200"
                    />
                    <input
                  ...
                  <div className="mt-2 p-3 bg-gray-50 rounded border border-gray-200">
                    ...
                    <p
                      style={{
                        color: config.textColors.description,
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Select a pre-designed template to quickly style your page. You
                can further customize it in the Design tab.
              </p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            template.config.background.type === "gradient"
                      ...
                      >
                        ...
                        <div className="absolute bottom-3 left-3 right-3 space-y-2">
                          <div
                            ...
                            style={{
                              backgroundColor:
                                template.config.buttons.backgroundColor,
                              color: template.config.buttons.textColor,
                              borderRadius:
                                template.config.buttons.style === "rounded"
                                  ? "6px"
                                  : template.config.buttons.style === "square"
                                  ? "0px"
                                  : "20px",
                              boxShadow: template.config.buttons.hasShadow
                      ...
                      <h4
                        className={`text-base mb-1 ${
                          isSelected ? "text-[#8129d9]" : "text-black"
                        }`}
                      >
                        {template.name}
                      </h4>
